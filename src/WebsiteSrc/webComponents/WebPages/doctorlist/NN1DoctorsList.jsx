...
// const NN1DoctorsList = () => {
//   const [activeTab, setActiveTab] = useState("NN1");
...
//     doctorsData1.forEach((doctor) => {
//       if (doctor.fld_practice_location_id && doctor.fld_practice_location_id.split("$").includes("1")) {
//         const departments = doctor.fld_department_Name.split("$");
...
const NN1DoctorsList = () => {
  ...
  //   doctorsData1.forEach((doctor) => {
  //     if (
  //       doctor.fld_practice_location_id &&
  //       doctor.fld_practice_location_id.split("$").includes("1")
  //     ) {
  //       const departments = doctor.fld_department_Name.split("$");
  ...
  const breadcrumbItems = [
    { label: "Media", url: "/" },
    { label: "Reviews", url: "/media" },
    { label: "Rajajinagar Reviews" },
  ];
  ...
  const fetchDoctorsForAllLocations = async () => {
    ...
    try {
      ...
      const results = await Promise.all(
        locations.map((locationId) =>
          WebApi.getDoctorsByPlace({ ...requestData, fld_practice_location_id: locationId })
        )
      );

      const allDoctors = results.flatMap((result) => result.responsemessage);
  ...
  return (
    <div className="list-doc">
      ...
      <div className="breadcrumbs1" style={{marginTop:"120px"}}>
            <a href="https://kavintechcorp.in/nnwps">Home</a> &gt; <a href="/doctors-nn1-rajaji-nagar">Our doctors</a> &gt;NN1 Rajajinagar
          </div>
