...
// const NN4DoctorsList = () => {
//   const [activeTab, setActiveTab] = useState("NN4");
...
//       if (doctor.fld_practice_location_id && doctor.fld_practice_location_id.split("$").includes("4")) {
...
const NN4DoctorsList = () => {
  ...
  const groupDoctorsByDepartment = () => {
    ...
    doctorsData1.forEach((doctor) => {
      // Check if 'fld_practice_location_id' contains '4'
      if (
        doctor.fld_practice_location_id &&
        doctor.fld_practice_location_id.split("$").includes("4")
      ) {
        const departments = doctor.fld_department_Name.split("$");
  ...
  return (
    <div className="list-doc">
      ...
      <div className="breadcrumbs1" style={{ marginTop: "120px" }}>
        <a href="https://kavintechcorp.in/nnwps">Home</a> &gt;{" "}
        <a href="/doctors-nn1-rajaji-nagar">Our doctors</a> &gt;NN4 Banneghatta Road
      </div>
      ...
      <div className="doctor-cards-container1">{renderDoctors()}</div>
