...
// const NN3DoctorsList = () => {
//   const [activeTab, setActiveTab] = useState("NN3");
...
//       if (doctor.fld_practice_location_id && doctor.fld_practice_location_id.split("$").includes("3")) {
...
const NN3DoctorsList = () => {
  ...
  const renderDoctors = () => {
    if (filteredDoctors.length > 0) {
      const groupedDoctors = groupDoctorsByDepartment(filteredDoctors);
      return Object.keys(groupedDoctors).map((department, index) => (
        <div key={index}>
          <h1 className="cat-sur">{department}</h1>
          <div className="doctor-cards-container">
  ...
  return (
    <div className="list-doc">
      ...
      <div className="breadcrumbs1" style={{ marginTop: "120px" }}>
        ...
        <a href="/doctors-nn1-rajaji-nagar">Our doctors</a> &gt;NN3 Indiranagar
      </div>
