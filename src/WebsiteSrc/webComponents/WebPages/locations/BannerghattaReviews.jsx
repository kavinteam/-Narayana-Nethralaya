    ...
    const fetchDoctorReviews = async () => {
      try {
        ...
        const requestData = {
          ...
          DbVersion: "10.4.1",
          DbSource: "W",
          fld_place_id:"ChIJv2Jfcs1qrjsRTzMHGwDuE3U"
        };
    ...
    <>
      ...
      <div className="list-doc">
        <div className="headerBanner">
          ...
          <div className="centreReviews"  style={{marginRight:"40px"}}>
            <h1 style={{ paddingTop: "20px" }}>
              <span className="bgt">Bannerghatta Reviews</span>
            </h1>
          </div>
        </div>
        {/* <div className="headerBanner">
          <img src="/bg-blck.webp" alt="banner" />
        ...
        <div className="breadcrumbs1">
            ...
            &gt;Bannerghatta Reviews
          </div>
        <div className="reviews-container">
        <div className="reviews-list">
          {locationReviews && locationReviews.length > 0 ? (
            locationReviews.slice(0, visibleReviews).map((review, index) => (
...
export default BannerghattaReviews;
