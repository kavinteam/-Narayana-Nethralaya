    ...
    const fetchLocationReviews = async () => {
      try {
        ...
        const requestData = {
          ...
          DbVersion: "10.4.1",
          DbSource: "W",
          fld_place_id: "ChIJ441Kr5I9rjsRm-EYn-cfOhE",
        };
    ...
    <>
      ...
      <div className="list-doc">
        <div className="headerBanner">
          ...
          <div className="centreReviews" style={{marginRight:"170px"}}>
            <h1 style={{ paddingTop: "20px" }}>
              <span>Rajajinagar Reviews</span>
            </h1>
          </div>
        </div>
        <div style={{ marginTop: "120px" }}>
        <div className="breadcrumbs1">
            <a href="https://kavintechcorp.in/nnwps/media">Media</a> &gt; <a href="/reviewsPage">Reviews</a> &gt;Rajajinagar Reviews
          </div>
            ...
            locationReviews.map((review, index) => (
              <div key={index}>
                <div className="review-card">
                  ...
                  <p className="review-text">{review.fld_place_name}</p>
                ...
                {index < locationReviews.length - 1 && (
      ...
      {locationReviews && locationReviews.length > 6 && (
        <div className="loadbtnContainer">
          <Button label="Load More..." className="loadMore" />
        </div>
      )} */}
          <div className="reviews-container">
            <div className="reviews-list">
...
export default RajajinagarReviews;
