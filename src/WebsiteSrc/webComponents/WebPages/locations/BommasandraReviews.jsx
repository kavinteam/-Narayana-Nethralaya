    ...
    const fetchDoctorReviews = async () => {
      try {
        ...
        const requestData = {
          ...
          DbVersion: "10.4.1",
          DbSource: "W",
          fld_place_id:"ChIJE19us1FtrjsRh17InKNqHv0"
        };
    ...
    <>
      ...
      <div className="list-doc">
        <div className="headerBanner">
          ...
          <div className="centreReviews"  style={{marginRight:"64px"}}>
            <h1 style={{ paddingTop: "20px" }}>
              <span>Bommasandra Reviews</span>
            </h1>
          </div>
        </div>
        {/* <div className="headerBanner">
...
export default BommasandraReviews;
